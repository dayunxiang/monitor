...
class InspectionUser extends React.Component {
    ...
    async AllList() {
        ...
        console.log( formatnowdate,'获取当前日期')
        // 获取一周前日期
        ...
        let param =  {
            ...
            conservancyId:this.WaterId,
            startSchedule:formatnowdate,  //开始排班时间
            endSchedule:formatwdate   //结束时间
           };
          ...
          <Row  style={{marginRight:'15px'}}>
            ...
            >
               ...
               <Option value="1">汛期</Option>
                ...
                <Col xs={24} sm={12}  md={4}>
                 {/* 工作时段 */}
                 {/* <label htmlFor="">工作时段</label> */}
                <div className="worktime">
                {/* <div className='text'>排班时间</div> */}
                <div > 
                {/* <label htmlFor="">排班时间</label> */}
                 <RangePicker
