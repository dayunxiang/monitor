...
import {Modal, Form, Input, Tooltip, Icon, Cascader, Select, Row, Col, Checkbox, Button, AutoComplete ,Table, Spin } from '../../../../components/Antd.js';
...
import "./style.css";
class Group extends BaseSubPage {
        ...
        return (
        	...
        	<div className="vk-subpage">
        		...
        		<Row>
				    ...
				    <Col  md={16} >
				    	<GroupForm ref="form" disabled={this.state.formDisable}/>
