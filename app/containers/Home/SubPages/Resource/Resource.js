...
import {Modal, Tree, Row, Col, Spin } from '../../../../components/Antd.js';
import BaseSubPage from '../BaseSubPage.js';

import ResourceForm from './ResourceForm/ResourceForm.js';
import Toolbar from '../../../../components/Toolbar/Toolbar.js';
import Cover from '../../../../components/Cover/Cover.js';
// import "./style.css";

class Resource extends BaseSubPage {
        ...
        return (
            ...
            <div className="vk-subpage">
                <Row>
                    ...
                    <Col  md={16} >
                        <ResourceForm ref="form" disabled={this.state.formDisable} />
                    </Col>
                </Row>
                <Modal
                  title="是否删除?"
