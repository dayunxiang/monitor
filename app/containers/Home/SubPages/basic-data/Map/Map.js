...
import FormMap from '../../../SubPages/basic-data/Map/FormMap.js';
import Toolbar from '../../../../../components/Toolbar/Toolbar.js';
import Cover from '../../../../../components/Cover/Cover.js';
// import "./style.css";
class Map extends BaseSubPage {
    ...
    render() {
        const columns = [
        	{title: '地图管理编码',dataIndex: 'code' ,width:"33%"},
        		...
        		<Row>
				    <Col  md={8} >
				    	...
				    	<Table ref="table" size={'small'} bordered={false} scroll={{y:this.state.tableSrcollY}} 
							...
							dataSource={this.state.tableData} bordered={true} 
							onRow={(record) => ({
								onClick: () => {
									this.setState({
										tableSelData: record
                            ...
                            rowClassName={this.rowClassName.bind(this)} pagination={{defaultPageSize:10}}/>
				    	<Cover cover={this.state.cover} fullScreen={false} topOffset={30}/>

				    </Col>
				    <Col  md={16} >
				    	{/* <FormMap ref="form" disabled={this.state.formDisable}/> */}
				    </Col>
				</Row>
				<Modal
		          title="是否删除?"
