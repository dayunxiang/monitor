...
import FormWaterPump from '../../../SubPages/basic-data/WaterPump/FormWaterPump.js'
import Modal from '../../../../../components/Modal/Modal.js';
import { postWaterPump, addWaterPump, modifyWaterPump, removeWaterPump, postDamTree, postRegionTree } from '../../../../../data/dataStore.js';
const ButtonGroup = Button.Group;
const Search = Input.Search;
const Option = Select.Option;
import {cloneObj} from "../../../../../util/common.js"
// import "./style.css";
class WaterPump extends BaseSubPage {
    ...
    render() {
        const columns = [
            ...
            {title: '规格',dataIndex: 'spec',width: "5%"},
            {title: '泵宽',dataIndex: 'pumpWidth',width: "10%"},
            {title: '流量',dataIndex: 'flow',width: "10%"},
    ...
    async loadTreeData() {
        let listPromise = postWaterPump({}).then((res) =>{ return res.ok ? res.json() : Promise.reject("接口出错");}).then((data) => {
            if (data.code === 200) {
                return data.data;
            }
    ...
    createModal() {
        let modal = 
         <Modal visible={this.state.showModal} width={"90%"} 
            ...
            <FormWaterPump ref={(node) => { this.f = node ;}} disabled={false}/>
